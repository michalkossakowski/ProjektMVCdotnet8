...
namespace ProjektMVCdotnet8.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "Nazwa użytkownika musi mieć co najmniej {2} i maksymalnie {1} znaków.", MinimumLength = 3)]
